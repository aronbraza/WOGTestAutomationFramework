...
public class CMS_EventsAndTrainingsTest extends base {
	...
	@Test(dataProvider="E_001", dataProviderClass=LoginTestData.class)
	public void CreateEvent(String Event_Privacy, String Event_Name, String Event_Location, String Event_Description, String Registration_Form_Template, String Event_StartDate, String Event_End_Date, String Registration_Start_Date, String Registration_End_Date, String FilePath, String Availability,  String Lifetime_Start_Date, String Custom_Start_Date, String Custom_End_Date,  String ImagePath, String Survey, String SurveyReq, String Slots, String Activate ) throws InterruptedException, IOException
	{
		...
		cmsLogin_Page.setUsername_Textbox("adminadmin");
		cmsLogin_Page.setPassword_Textbox("Admin123");
		...
		cmsEvents_Page.setCustom_Start_Date_Textbox(Custom_Start_Date);
		cmsEvents_Page.setCustom_End_Date_Textbox(Custom_End_Date);
